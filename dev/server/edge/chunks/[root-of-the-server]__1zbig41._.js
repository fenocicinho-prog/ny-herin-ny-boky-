...
const protectedRoutes = {
    "/client": "CLIENT",
    "/vendeur": "VENDOR",
    "/inscription/vendeur/abonnement": "VENDOR",
    "/inscription/vendeur/livres": "VENDOR"
};
function middleware(request) {
    ...
    if (!sessionCookie) {
        const loginUrl = protectedRoutes[matchedRoute] === "VENDOR" ? new URL("/connexion/vendeur", request.url) : new URL("/connexion/client", request.url);
