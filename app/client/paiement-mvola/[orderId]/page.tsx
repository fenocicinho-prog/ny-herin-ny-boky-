  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-white to-stone-50 px-4 py-10 sm:py-14">
      <div className="mx-auto max-w-md">
        ...
        {/* Indicateur de progression — reflète le vrai statut de la commande */}
        ...
        <div className="overflow-hidden rounded-3xl border border-amber-100 bg-white shadow-xl shadow-amber-900/5">
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-amber-600 via-amber-700 to-amber-900 px-6 py-9 text-center text-white">
            ...
            <p className="relative mt-2 truncate text-sm text-amber-100/90">{bookTitle}</p>
          </div>

          {/* Numéro MVola — chip copiable */}
          ...
          {/* Instructions — timeline calquée sur le vrai parcours téléphone/SMS */}
              ...
              {steps.map((step, i) => {
                ...
                return (
                  <div key={i} className="relative flex gap-4">
                    ...
                    <div className="flex-1 pt-2.5 text-sm text-stone-600">
                      {step.content}
                    </div>
                  </div>
                );
        ...
        {/* Soumission de la preuve — dernière étape, mise en avant */}
